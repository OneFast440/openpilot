...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    // NEW: SunnyLink "Other" adjustable params
    {"HumanTurnReset", {PERSISTENT | BACKUP, BOOL, "0"}},                       // On/Off
    {"PredictedCurvatureBlendRatio", {PERSISTENT | BACKUP, FLOAT, "0.2"}},      // 0.20 - 0.60 step 0.1
    {"LaneChangeFactor", {PERSISTENT | BACKUP, FLOAT, "0.5"}},                  // 0.5 - 1.0 step 0.05
    {"EnableAdvancedLanePositioning", {PERSISTENT | BACKUP, BOOL, "0"}},        // On/Off
    {"EnableLanefullMode", {PERSISTENT | BACKUP, BOOL, "0"}},  
};
