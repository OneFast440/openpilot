...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    # The large-screen UI has a vehicle panel; mici did not, so per-vehicle tuning was only
    # reachable through sunnylink.
    vehicle_panel = VehicleLayoutMici()
    vehicle_btn = SettingsBigButton(tr("vehicle"), "",
                                    gui_app.texture("../../sunnypilot/selfdrive/assets/offroad/icon_vehicle.png",
                                                    ICON_SIZE, ICON_SIZE))
